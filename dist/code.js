...
figma.ui.onmessage = (msg) => {
    ...
    if (msg.type === "create-shapes" || msg.type === "create-spiral") {
        ...
        svgPath = figma.createNodeFromSvg(`<svg xmlns="http://www.w3.org/2000/svg"><path d="${pathDAttribute}" fill="none" stroke="black" stroke-width="${msg.data.lineWidth}px"/> </svg>`);
...
function makeSpiralPoints(data) {
